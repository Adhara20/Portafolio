...
<body>
    ...
    <div class="flex justify-center items-center">
        <div class="tarjeta2 bg-gray-800">
            <p class="text-justify font-semibold text-sm leading-5 sm:text-base sm:leading-6 md:text-lg/8 mx-auto max-w-[70%]">
                ...
                <span class="text-blue-700">var</span> <span class="text-blue-400">pr</span> <span class="text-white">=</span> <span class="text-blue-700">0</span><span class="text-white">;</span><br>
                ...
                <span class="text-amber-400">while</span><span class="text-purple-600">(</span><span class="text-blue-400">c</span><span class="text-white">></span><span class="text-blue-700">0</span><span class="text-purple-600">)</span><span class="text-purple-600">{</span><br>
                ...
                &nbsp;&nbsp;<span class="text-amber-400">if</span><span class="text-purple-600">(</span><span class="text-blue-400">es1</span> <span class="text-white">===</span> <span class="text-blue-700">null</span> <span class="text-white">||</span> <span class="text-blue-400">es1</span><span class="text-amber-100">.trim</span><span class="text-purple-600">(</span><span class="text-purple-600">)</span> <span class="text-white">===</span> <span class="text-[#AD6D3B]">""</span><span class="text-purple-600">)</span><span class="text-purple-600">{</span><br>
                ...
                <br>
                &nbsp;&nbsp;<span class="text-amber-400">if</span><span class="text-purple-600">(</span><span class="text-amber-100">isNaN</span><span class="text-purple-600">(</span><span class="text-blue-400">es2</span><span class="text-purple-600">)</span><span class="text-purple-600">)</span><span class="text-purple-600">{</span><br>
    ...
    <div class="flex justify-center items-center gap-6 mb-4 mt-4">
        <button class="buttonSiguiente w-32 flex" onclick="window.location.href='/Portafolio/ciclosJavascript/while/Ejercicio1w.php'">
