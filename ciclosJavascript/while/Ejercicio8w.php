    ...
    <div class="flex justify-center items-center">
        <div class="tarjeta2 bg-gray-800">
            <p class="text-justify font-semibold text-sm leading-5 sm:text-base sm:leading-6 md:text-lg/8 mx-auto max-w-[70%]">
                ...
                <span class="text-amber-400">while</span><span class="text-purple-600">(</span><span class="text-blue-400">i</span><span class="text-white"><=</span><span class="text-blue-700">6</span><span class="text-purple-600">)</span><span class="text-purple-600">{</span><br>
                ...
                &nbsp;&nbsp;<span class="text-blue-400">resultado</span> <span class="text-white">+=</span> <span class="text-blue-400">i</span><span class="text-white">+</span><span class="text-[#AD6D3B]">".- El incremento es: "</span><span class="text-white">+</span><span class="text-blue-400">inc</span><span class="text-white">+</span><span class="text-[#AD6D3B]">" --> salario : "</span><span class="text-white">+</span><span class="text-blue-400">sal</span><span class="text-white">+</span><span class="text-[#AD6D3B]">"\n"</span><span class="text-white">;</span><br>
    ...
    <script>
        function ejecutar(){
            ...
            while(i<=6){
                inc = sal * 0.10;
                sal = sal + inc;
                resultado += i + ".- El incremento es: " + inc + " --> salario : " + sal + "\n";
                i++;
            }
            alert(resultado);
        }
