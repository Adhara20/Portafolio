...
<head>
    ...
    <title>Ejercicio Do While 1</title>
</head>
<body>
    ...
    <div class="flex justify-center items-center">
        <div class="tarjeta2 bg-gray-800">
            <p class="text-justify font-semibold text-sm leading-5 sm:text-base sm:leading-6 md:text-lg/8 mx-auto max-w-[70%]">
                ...
                <span class="text-amber-100">alert</span><span class="text-purple-600">(</span><span class="text-[#AD6D3B]">"La edad promedio es "</span><span class="text-white">+</span><span class="text-amber-100">parseInt</span><span class="text-purple-600">(</span><span class="text-blue-400">prom</span><span class="text-purple-600">)</span><span class="text-white">+</span><span class="text-[#AD6D3B]">" años."</span><span class="text-purple-600">)</span><span class="text-white">;</span><br>
    ...
    <script>
        function ejecutar(){
            ...
            alert("La edad promedio es "+parseInt(prom)+" años.")
        }
    </script>
