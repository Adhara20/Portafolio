...
<head>
    ...
    <title>Ejercicio Do While 4</title>
</head>
<body>
    ...
    <div class="flex justify-center items-center">
        <div class="tarjeta2 bg-gray-800">
            <p class="text-justify font-semibold text-sm leading-5 sm:text-base sm:leading-6 md:text-lg/8 mx-auto max-w-[70%]">
                ...
                <span class="text-blue-700">var</span> <span class="text-blue-400">ia</span><span class="text-white">=</span> <span class="text-blue-700">150</span><span class="text-white">,</span> <span class="text-blue-400">iz</span><span class="text-white">=</span><span class="text-blue-700">70</span><span class="text-white">,</span> <span class="text-blue-400">pe</span><span class="text-white">=</span><span class="text-blue-700">0</span><span class="text-white">;</span><br>
                ...
                <span class="text-purple-600">}</span><span class="text-amber-400">while</span><span class="text-purple-600">(</span><span class="text-blue-400">iz</span><span class="text-white">!=</span><span class="text-blue-400">ia</span><span class="text-purple-600">)</span><span class="text-white">;</span><br>
