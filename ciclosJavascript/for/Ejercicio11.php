    ...
    <div class="pt-20 px-6">
        ...
        <div class="items-center ml-8 mr-8">
            <p class="text-justify text-lg/10 font-semibold">
                11. Contar la cantidad de focos de diferentes colores (verde, blanco, rojo) de un total de N focos.
            </p>
        </div>
    </div>
    ...
    <div class="flex justify-center items-center">
        <div class="tarjeta2 bg-gray-800">
            <p class="text-justify font-semibold text-sm leading-5 sm:text-base sm:leading-6 md:text-lg/8 mx-auto max-w-[70%]">
                ...
                &nbsp;&nbsp;<span class="text-purple-600">}</span> <span class="text-pink-300">else if</span> <span class="text-purple-600">(</span><span class="text-blue-400">color</span> <span class="text-white">===</span> <span class="text-[#AD6D3B]">"blanco"</span><span class="text-purple-600">)</span> <span class="text-purple-600">{</span><br>
                &nbsp;&nbsp;&nbsp;&nbsp;<span class="text-blue-400">blancos</span><span class="text-white">++</span><span class="text-white">;</span><br>
                &nbsp;&nbsp;<span class="text-purple-600">}</span> <span class="text-pink-300">else if</span> <span class="text-purple-600">(</span><span class="text-blue-400">color</span> <span class="text-white">===</span> <span class="text-[#AD6D3B]">"rojo"</span><span class="text-purple-600">)</span> <span class="text-purple-600">{</span><br>
                ...
                <span class="text-purple-600">}</span><br>
                <span class="text-blue-700">alert</span><span class="text-purple-600">(</span><span class="text-[#AD6D3B]">"Cantidad de focos verdes: "</span><span class="text-white">+</span><span class="text-blue-400">verdes</span><span class="text-white">+</span><span class="text-[#AD6D3B]">"\nCantidad de focos blancos: "</span><span class="text-white">+</span><span class="text-blue-400">blancos</span><span class="text-white">+</span><span class="text-[#AD6D3B]">"\nCantidad de focos rojos: "</span><span class="text-white">+</span><span class="text-blue-400">rojos</span><span class="text-purple-600">)</span><span class="text-white">;</span><br>
