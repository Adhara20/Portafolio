...
<body>
    ...
    <div class="flex justify-center items-center">
        <div class="tarjeta2 bg-gray-800">
            <p class="text-justify font-semibold text-sm leading-5 sm:text-base sm:leading-6 md:text-lg/8 mx-auto max-w-[70%]">
                ...
                <span class="text-blue-700">var</span> <span class="text-blue-400">a</span><span class="text-white">=</span><span class="text-blue-700">0</span><span class="text-white">,</span> <span class="text-blue-400">b</span><span class="text-white">=</span><span class="text-blue-700">0</span><span class="text-white">,</span> <span class="text-blue-400">c</span><span class="text-white">=</span><span class="text-blue-700">0</span><span class="text-white">,</span> <span class="text-blue-400">t1</span><span class="text-white">=</span><span class="text-blue-700">0</span><span class="text-white">,</span> <span class="text-blue-400">t2</span><span class="text-white">=</span><span class="text-blue-700">0</span><span class="text-white">,</span> <span class="text-blue-400">t3</span><span class="text-white">=</span><span class="text-blue-700">0</span><span class="text-white">;</span><br><br>
                ...
                &nbsp;&nbsp;<span class="text-purple-600">}</span><span class="text-pink-300">else if</span><span class="text-purple-600">(</span><span class="text-blue-400">v</span><span class="text-white"><=</span><span class="text-blue-700">1000</span> <span class="text-white">&&</span> <span class="text-blue-400">v</span><span class="text-white">></span><span class="text-blue-700">500</span><span class="text-purple-600">)</span><span class="text-purple-600">{</span><br>
                ...
                &nbsp;&nbsp;<span class="text-purple-600">}</span><span class="text-pink-300">else if</span><span class="text-purple-600">(</span><span class="text-blue-400">v</span><span class="text-white"><=</span><span class="text-blue-700">500</span><span class="text-purple-600">)</span><span class="text-purple-600">{</span><br>
                ...
                <span class="text-amber-100">alert</span><span class="text-purple-600">(</span><span class="text-[#AD6D3B]">"Total de ventas categoria A: "</span><span class="text-white">+</span><span class="text-blue-400">a</span><span class="text-white">+</span><br>
                &nbsp;&nbsp;<span class="text-[#AD6D3B]">"\nMonto total de categoria A: "</span><span class="text-white">+</span><span class="text-blue-400">t1</span><span class="text-white">+</span><span class="text-[#AD6D3B]">". Total de ventas categoria B: "</span><span class="text-white">+</span><br>
                &nbsp;&nbsp;<span class="text-[#AD6D3B]">""</span><span class="text-white">+</span><span class="text-blue-400">b</span><span class="text-white">+</span><span class="text-[#AD6D3B]">". Monto total de categoria B: "</span><span class="text-white">+</span><span class="text-blue-400">t2</span><span class="text-white">+</span><br>
                &nbsp;&nbsp;<span class="text-[#AD6D3B]">"\nTotal de ventas categoria C: "</span><span class="text-white">+</span><span class="text-blue-400">c</span><span class="text-white">+</span><br>
                &nbsp;&nbsp;<span class="text-[#AD6D3B]">". Monto total de categoria C: "</span><span class="text-white">+</span><span class="text-blue-400">t3</span><span class="text-purple-600">)</span><span class="text-white">;</span><br>
    ...
    <div class="flex justify-center items-center gap-6 mb-4 mt-4">
        <button class="buttonSiguiente w-32 flex" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio4.php'">
    ...
    <script>
        function ejecutar(){
            ...
            var a = 0, b = 0, c = 0, t1 = 0, t2 = 0, t3 = 0;
            for(var i = 1; i <= n; i++) {
            ...
            var totalVentas = t1 + t2 + t3;
            alert("Total de ventas categoria A: " + a +
                  "\nMonto total de categoria A: " + t1 + 
                  "\n\nTotal de ventas categoria B: " + b + 
                  "\nMonto total de categoria B: " + t2 +
                  "\n\nTotal de ventas categoria C: " + c +
                  "\nMonto total de categoria C: " + t3 +
                  "\n\nMonto total global: " + totalVentas);
        }
    </script>
