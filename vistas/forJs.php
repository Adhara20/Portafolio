...
<div class="pt-20 px-6">
    ...
    <div class="tarjeta-contenedor">
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio1.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio2.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio3.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio4.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio5.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio6.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio7.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio8.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio9.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio10.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio11.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio12.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio13.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/for/Ejercicio14.php'">
                Ejecutar
            </button>
        </div>
    </div>
