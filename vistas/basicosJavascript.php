...
<div class="pt-20 px-6">
  ...
  <!-- resto del contenido -->
   <h2 class="subTitulo text-3xl text-[#0d0221] font-semibold">Ejercicios Propuestos por el Profesor</h2>
<div class="tarjeta-contenedor">
  ...
  <div class="tarjeta">
    <p>
      6.Escriba un programa tal que, dado como datos el nombre de un dinosaurio, su peso y longitud, 
  ...
  <div class="tarjeta">
    <p>
      7.Construya un programa que resuelva el problema que tienen en una gasolinera. 
      Los surtidores de la misma registran lo que “surten” en galones, pero el precio 
      de la gasolina está fijado en litros. El diagrama de flujo debe calcular e imprimir 
  ...
  <div class="tarjeta">
    <p>
      12.Construya un programa que sea capaz de intercambiar el valor de tres variables, 
  ...
  <div class="tarjeta">
    <p>
      13.Escriba un programa que calcule el número mínimo de billetes de 20, 
  ...
  <div class="tarjeta">
    <p>
      17.En las olimpiadas de invierno el tiempo que realizan los participantes en la competencia de velocidad en pista, 
  ...
  <div class="tarjeta">
    <p>
      18.Construya un programa, que dado el radio, la generatriz y la altura de un cono; 
  ...
  <div class="tarjeta">
    <p>
      23.Determinar la suma de los N primeros números enteros positivos, use la siguiente formula: 
  ...
  <div class="tarjeta">
    <p>
        24.Calcular el interés compuesto generado por un capital depositado durante cierta cantidad de tiempo a una tasa de interés determinada, aplique las siguientes fórmulas.
        a. M = (1+r/100)t*C
        b. i = M – C
    </p>
    <br>
  ...
  <div class="tarjeta">
    <p>
      31.Juan Carlos es jefe de bodega en una fábrica de pañales desechables y sabe que la producción diaria es de 744 pañales y que en cada 
      caja donde se empacan para la venta caben 12 pañales. ¿Cuántas cajas debe conseguir Juan Carlos para empacar los pañales fabricados en 
      una semana (5 días)?
    </p>
    <br>
