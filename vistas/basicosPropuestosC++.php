...
<div class="pt-20 px-4 sm:px-6 mb-8">
    ...
    <h1 class="titulo text-2xl sm:text-3xl text-[#26408b] font-semibold text-center sm:text-left">
        Ejercicios Básicos (Propuestos) C++
    </h1>
    ...
    <div class="w-full flex justify-center">
        <embed 
            src="../pdf/Ejercicios_propuestos_c++.pdf#zoom=page-width" 
    ...
    <p class="mt-4 text-center sm:text-left">
        ...
        <a class="text-blue-600 underline" href="../pdf/Ejercicios_propuestos_c++.pdf" download>
            descárgalo aquí
        </a>.
    </p>
