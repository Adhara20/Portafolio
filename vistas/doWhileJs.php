...
<div class="pt-20 px-6">
  <div class="flex">
    ...
    <h2 class="subTitulo text-3xl text-[#0d0221] font-semibold">Ciclo DoWhile</h2>
    </div>
  ...
  <div class="tarjeta">
    ...
    <br>
    <button class="buttonEjecutar" onclick="window.location.href='/Portafolio/carpeta/ejercicio.html'">Ejecutar</button>
  </div>
  <div class="tarjeta">
    <p>El aprendizaje constante impulsa la creatividad y fortalece la mente.
       Cada proyecto representa una oportunidad para explorar nuevas ideas, 
