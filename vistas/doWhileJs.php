...
<div class="pt-20 px-6">
    ...
    <div class="tarjeta-contenedor">
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw1.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw2.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw3.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw4.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw5.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw6.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw7.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw8.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw9.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw10.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw11.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw12.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw13.php'">
                Ejecutar
            </button>
        </div>
        ...
        <div class="tarjeta">
            ...
            <br>
            <button class="buttonEjecutar button:hover" onclick="window.location.href='/Portafolio/ciclosJavascript/dowhile/dw14.php'">
                Ejecutar
            </button>
        </div>
    </div>
