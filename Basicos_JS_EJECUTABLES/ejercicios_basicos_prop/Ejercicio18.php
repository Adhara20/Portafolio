...
<head>
    ...
    <title>Ejercicio Propuesto 18</title>
</head>
<body>
    <div class="pt-20 px-6">
        ...
        <div class="items-center ml-8 mr-8">
            <p class="text-justify text-lg/10 font-semibold">
                18.- Crear un programa que permita al usuario realizar operaciones aritméticas básicas con tan solo dos números ingresados: suma, resta, multiplicación y división.
            </p>
        </div>
    </div>
    ...
    <div class="flex justify-center items-center">
        <div class="tarjeta2 bg-gray-800">
            <p class="text-justify font-semibold text-sm leading-5 sm:text-base sm:leading-6 md:text-lg/8 mx-auto max-w-[70%]">
                ...
                <span class="text-[#AD6D3B]">"Resultados:\n"</span> <span class="text-white">+</span> <span class="text-[#AD6D3B]">"Suma:"</span> <span class="text-white">+</span> <span class="text-blue-400">S</span> <span class="text-white">+</span> <span class="text-[#AD6D3B]">"\n"</span> <span class="text-white">+</span> <span class="text-[#AD6D3B]">"Resta:"</span> <span class="text-white">+</span> <span class="text-blue-400">R</span> <span class="text-white">+</span> <span class="text-[#AD6D3B]">"\n"</span> <span class="text-white">+</span> <span class="text-[#AD6D3B]">"Multiplicación:"</span> <span class="text-white">+</span> <span class="text-blue-400">M</span> <span class="text-white">+</span> <span class="text-[#AD6D3B]">"\n"</span> <span class="text-white">+</span> <span class="text-[#AD6D3B]">"División:"</span> <span class="text-white">+</span> <span class="text-blue-400">D</span>
    ...
    <div class="flex justify-center items-center gap-6 mb-4 mt-4">
        <button class="buttonSiguiente w-32 flex" onclick="window.location.href='/Portafolio/Basicos_JS_EJECUTABLES/ejercicios_basicos_prop/Ejercicio17.php'">
        ...
        <button class="buttonSiguiente w-32 flex" onclick="window.location.href='/Portafolio/Basicos_JS_EJECUTABLES/ejercicios_basicos_prop/Ejercicio19.php'">
            Siguiente
