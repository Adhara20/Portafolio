...
<head>
    ...
    <title>Ejercicio Básico JS 22</title>
</head>
<body>
    <div class="pt-20 px-6">
        ...
        <div class="items-center ml-8 mr-8">
            <p class="text-justify text-lg/10 font-semibold">
                22.- Hallar la radicación de <sup>n</sup>√A, donde A y n pertenecen a Z (números enteros positivos).
            </p>
        </div>
    </div>
    ...
    <div class="flex justify-center items-center">
        <div class="tarjeta2 bg-gray-800">
            <p class="text-justify font-semibold text-sm leading-5 sm:text-base sm:leading-6 md:text-lg/8 mx-auto max-w-[70%]">
                ...
                <span class="text-amber-100">prompt</span>
                <span class="text-purple-600">(</span>
                <span class="text-[#AD6D3B]">"ingresa el valor de n: "</span>
                <span class="text-purple-600">)</span>
                <span class="text-purple-600">)</span><span class="text-white">;</span><br>
                ...
                <span class="text-purple-600">(</span><span class="text-blue-400">a</span><span class="text-white">,</span><span class="text-green-300">1.0</span><span class="text-white">/</span><span class="text-blue-400">n</span><span class="text-purple-600">)</span>
                <span class="text-purple-600">)</span><span class="text-white">;</span><br>
                
                <span class="text-amber-100">alert</span>
                <span class="text-purple-600">(</span>
                <span class="text-[#AD6D3B]">"la radicacion es "</span> <span class="text-white">+</span> <span class="text-blue-400">r</span>
                <span class="text-purple-600">)</span><span class="text-white">;</span><br>
    ...
    <script>
        function ejecutar(){
            ...
            var n = parseInt(prompt("ingresa el valor de n"));
            var r =parseInt (Math.pow(a,1.0/n));
            alert("la radicacion es "+r);
        }
    </script>
